    ...
    public partial class RevokeRole : Form
    {
        ...
        public void displayData()
        {
            using (OracleConnection orcCont = new OracleConnection(KetNoi.AdminConnect))
            {
                ...
                OracleDataAdapter orcData3 = new OracleDataAdapter("select TABLE_NAME, PRIVILEGE from USER_TAB_PRIVS WHERE GRANTEE = '" + strTemp + "' AND TYPE = 'TABLE'" + " ORDER BY TABLE_NAME ASC", orcCont);
