    ...
    public partial class View_Detail : Form
    {
        ...
        public void displayData()
        {
            using (OracleConnection orcCont = new OracleConnection(KetNoi.AdminConnect))
            {
                ...
                OracleDataAdapter orcData3 = new OracleDataAdapter("select TABLE_NAME, PRIVILEGE from USER_TAB_PRIVS WHERE GRANTEE = '" + txtEdit_username.Text + "' AND TYPE = 'TABLE'", orcCont);
                ...
                OracleDataAdapter orcData5 = new OracleDataAdapter("select TABLE_NAME AS VIEW_NAME, PRIVILEGE from USER_TAB_PRIVS WHERE GRANTEE = '" + txtEdit_username.Text + "' AND TYPE = 'VIEW'", orcCont);
